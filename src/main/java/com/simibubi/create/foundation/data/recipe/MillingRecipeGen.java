...
public class MillingRecipeGen extends ProcessingRecipeGen {
	...
	GRANITE = create(() -> Blocks.GRANITE, b -> b.duration(200)
		...
		BWG_HORSEWEED = bwgFlower("horseweed", List.of(1f,.05f),
				List.of(Items.YELLOW_DYE, Items.GREEN_DYE), List.of(1,1)),
		...
		BWG_JAPANESE_ORCHID = bwgFlower("japanese_orchid", List.of(1f,.05f),
		...
		BWG_TALL_WHITE_ALLIUM = bwgFlower("tall_white_allium", List.of(1f,.25f),
				List.of(Items.WHITE_DYE, Items.WHITE_DYE), List.of(3,2)),
		...
		BWG_WHITE_ALLIUM = bwgFlower("white_allium", List.of(1f,.1f),
				List.of(Items.WHITE_DYE, Items.PURPLE_DYE), List.of(2,1)),
